def get_block(ui_data=None):
    ...
    seq = [
        # SHOULDER FOUNDATION removed; template 2 does not use explicit shoulder skeleton pins here.

        # NECK FOUNDATION
        {'ID': 'skel_neck_pin_R',    'Type': 'Line', 'IsConstruction': True, 'Points': [[0.001, waist_y], ['WaistSpan/2', waist_y]], 'StartID': 'skel_neck_pin_R:S', 'EndID': 'skel_neck_pin_R:E'},
        {'ID': 'skel_neck_pin_L',    'Type': 'Line', 'IsConstruction': True, 'Points': [[-0.001, waist_y], ['-WaistSpan/2', waist_y]], 'StartID': 'skel_neck_pin_L:S', 'EndID': 'skel_neck_pin_L:E'},
        {'Type': 'Horizontal', 'Targets': ['skel_neck_pin_R', 'skel_neck_pin_L'], 'Name': 'neck_horiz', 'CK': 'ck_skel_neck_horiz'},
        # Symmetry handled in p13_symmetry
        {'Type': 'Coincident', 'Targets': ['skel_neck_pin_R:S', 'Y_AXIS'],             'Name': 'neck_y_lock'},
        {'Type': 'Coincident', 'Targets': ['skel_neck_pin_R:S', 'skel_neck_pin_L:S'], 'Name': 'neck_merge'},
    ...
    if is_pinned:
        seq.append({'Type': 'Coincident', 'Targets': ['skel_neck_pin_R:S', 'ORIGIN'], 'Name': 'neck_origin_lock', 'AllowNudge': True})
    else:
        seq.append({'Type': 'VerticalDistance', 'Targets': ['skel_neck_pin_R:S', 'ORIGIN'], 'Expression': 'WaistOffset', 'Name': 'dim_neck_offset'})
