import importlib
try:
    from phases import p1_projs, p2_anatomy, p3_loop, p4_chain, p4b_horns, p5_tangency, p6_welds
except ImportError:
...
def get_sketch(ui_data=None):
    ...
    Phase map:
      ...
      6  p6_welds    – skeleton center welds (arc :C → anatomy pins)
    """
    # Force reload of all phase modules during development
    for m in [p1_projs, p2_anatomy, p3_loop, p4_chain, p4b_horns, p5_tangency, p6_welds]:
        importlib.reload(m)
