def get_block(ui_data=None):
    ...
    seq = [
        ...
        {'Type': 'Coincident', 'Targets': ['proj_horn_TR:E',            'proj_arc_shoulder_R:S']},
        {'Type': 'Coincident', 'Targets': ['proj_arc_shoulder_R:E',     'proj_arc_waist_R:S']},
    ...
    return {"Name": "Enclosure Welds", "PhaseID": "p03_02_encl_welds", "BuildSequence": seq}
