...
import T5_sketch_1_bounding_box, T5_sketch_2_shape_outline, T5_sketch_3_frame_enclosure

def reload_modules():
    """Manual reload of the entire template tree to ensures stability in Fusion 360."""
    importlib.reload(T5_sketch_1_bounding_box)
    importlib.reload(T5_sketch_2_shape_outline)
    importlib.reload(T5_sketch_3_frame_enclosure)

reload_modules()

from T5_sketch_1_bounding_box import get_sketch as get_sketch_1
from T5_sketch_2_shape_outline import get_sketch as get_sketch_2
from T5_sketch_3_frame_enclosure import get_sketch as get_sketch_3
